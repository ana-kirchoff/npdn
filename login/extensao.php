    ...
    ?>
        ...
        <div class="login-page">
            ...
            <form class="login-form" action="?act=save" method="POST" name="form1" >
				...
				<div class="inputWithIcon">
                Situação:
                <select class="selecao" name="Situacao" id="Situacao">
                ...
                <div class="inputWithIcon">
                Link imagem:
                <input type="text" name="Imagem"  <?php
                // Preenche o Descricao no campo imagem com um valor "value"
